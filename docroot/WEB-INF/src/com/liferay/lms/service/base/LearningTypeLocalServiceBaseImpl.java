...
public abstract class LearningTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LearningTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public LearningType addLearningType(LearningType learningType)
		...
		return learningTypePersistence.update(learningType, false);
	}
	...
	public LearningType deleteLearningType(long typeId)
		throws PortalException, SystemException {
		return learningTypePersistence.remove(typeId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LearningType deleteLearningType(LearningType learningType)
		throws SystemException {
		return learningTypePersistence.remove(learningType);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(LearningType.class,
	...
	public LearningType updateLearningType(LearningType learningType,
		...
		return learningTypePersistence.update(learningType, merge);
	}
	...
	private LearningTypeLocalServiceClpInvoker _clpInvoker = new LearningTypeLocalServiceClpInvoker();
}