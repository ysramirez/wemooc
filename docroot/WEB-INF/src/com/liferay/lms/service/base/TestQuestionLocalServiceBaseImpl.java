...
public abstract class TestQuestionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TestQuestionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TestQuestion addTestQuestion(TestQuestion testQuestion)
		...
		return testQuestionPersistence.update(testQuestion, false);
	}
	...
	public TestQuestion deleteTestQuestion(long questionId)
		throws PortalException, SystemException {
		return testQuestionPersistence.remove(questionId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TestQuestion deleteTestQuestion(TestQuestion testQuestion)
		throws SystemException {
		return testQuestionPersistence.remove(testQuestion);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TestQuestion.class,
	...
	public TestQuestion updateTestQuestion(TestQuestion testQuestion,
		...
		return testQuestionPersistence.update(testQuestion, merge);
	}
	...
	private TestQuestionLocalServiceClpInvoker _clpInvoker = new TestQuestionLocalServiceClpInvoker();
}