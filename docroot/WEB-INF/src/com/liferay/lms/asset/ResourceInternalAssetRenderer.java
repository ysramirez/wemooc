...
public class ResourceInternalAssetRenderer extends BaseAssetRenderer {
		...
		public String render(RenderRequest request, RenderResponse response,
					...
					LiferayPortletResponse liferayPortletResponse) throws Exception 
			{
			 ...
			 PortletURL portletURL = liferayPortletResponse.createRenderURL(
					 "resourceInternalActivity_WAR_liferaylmsportlet");

			  portletURL.setParameter("mvcPath", "/html/resourceInternalActivity/admin/edit.jsp");
			  portletURL.setParameter("jspPage", "/html/resourceInternalActivity/admin/edit.jsp");
			...
			public String getURLViewInContext(
				...
				PortletURL viewPortletURL = liferayPortletResponse.createRenderURL("resourceInternalActivity_WAR_liferaylmsportlet");
	            viewPortletURL.setWindowState(LiferayWindowState.NORMAL);
				viewPortletURL.setParameter(
					"jspPage", "/html/resourceInternalActivity/view.jsp");
				viewPortletURL.setParameter(
					"actId",Long.toString( _learningactivity.getActId()));
