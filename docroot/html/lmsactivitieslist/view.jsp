...
<ul>
	<li class="informacionmodule">
		<a href="<%=selectModuleURL.toString()%>"><liferay-ui:message key="challenge-information" /></a>
	</li>
	<li class="iniciarRetoModule option-less"><span class="desplegar"><liferay-ui:message key="challenge-begin" /></span>
		<ul>
			<%
			for (LearningActivity activity : activities) {
