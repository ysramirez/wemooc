...
/**
 * The base implementation of the s c o r m content local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.SCORMContentLocalServiceImpl}.
 * </p>
 *
 * @author TLS
 * @see com.liferay.lms.service.impl.SCORMContentLocalServiceImpl
 * @see com.liferay.lms.service.SCORMContentLocalServiceUtil
 * @generated
 */
public abstract class SCORMContentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SCORMContentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.SCORMContentLocalServiceUtil} to access the s c o r m content local service.
	 */

	/**
	 * Adds the s c o r m content to the database. Also notifies the appropriate model listeners.
	 *
	 * @param scormContent the s c o r m content
	 * @return the s c o r m content that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SCORMContent addSCORMContent(SCORMContent scormContent)
		throws SystemException {
		scormContent.setNew(true);

		return scormContentPersistence.update(scormContent, false);
	}
	 ...
	 */
	public SCORMContent createSCORMContent(long scormId) {
		return scormContentPersistence.create(scormId);
	}

	/**
	 * Deletes the s c o r m content with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param scormId the primary key of the s c o r m content
	 * @return the s c o r m content that was removed
	 * @throws PortalException if a s c o r m content with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public SCORMContent deleteSCORMContent(long scormId)
		throws PortalException, SystemException {
		return scormContentPersistence.remove(scormId);
	}

	/**
	 * Deletes the s c o r m content from the database. Also notifies the appropriate model listeners.
	 *
	 * @param scormContent the s c o r m content
	 * @return the s c o r m content that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public SCORMContent deleteSCORMContent(SCORMContent scormContent)
		throws SystemException {
		return scormContentPersistence.remove(scormContent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SCORMContent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return scormContentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return scormContentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SCORMContent fetchSCORMContent(long scormId)
		throws SystemException {
		return scormContentPersistence.fetchByPrimaryKey(scormId);
	}

	/**
	 * Returns the s c o r m content with the primary key.
	 *
	 * @param scormId the primary key of the s c o r m content
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SCORMContent getSCORMContent(long scormId)
		throws PortalException, SystemException {
		return scormContentPersistence.findByPrimaryKey(scormId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return scormContentPersistence.findByPrimaryKey(primaryKeyObj);
	}

	/**
	 * Returns the s c o r m content with the UUID in the group.
	 *
	 * @param uuid the UUID of s c o r m content
	 * @param groupId the group id of the s c o r m content
	 * @return the s c o r m content
	 * @throws PortalException if a s c o r m content with the UUID in the group could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public SCORMContent getSCORMContentByUuidAndGroupId(String uuid,
		long groupId) throws PortalException, SystemException {
		return scormContentPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SCORMContent> getSCORMContents(int start, int end)
		throws SystemException {
		return scormContentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSCORMContentsCount() throws SystemException {
		return scormContentPersistence.countAll();
	}

	/**
	 * Updates the s c o r m content in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param scormContent the s c o r m content
	 * @return the s c o r m content that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SCORMContent updateSCORMContent(SCORMContent scormContent)
		throws SystemException {
		return updateSCORMContent(scormContent, true);
	}
	 ...
	 *
	 * @param scormContent the s c o r m content
	 * @param merge whether to merge the s c o r m content with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the s c o r m content that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SCORMContent updateSCORMContent(SCORMContent scormContent,
		...
		return scormContentPersistence.update(scormContent, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.SCORMContent",
			scormContentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = scormContentPersistence.getDataSource();
	...
	private SCORMContentLocalServiceClpInvoker _clpInvoker = new SCORMContentLocalServiceClpInvoker();
}