...
/**
 * The base implementation of the check p2p mailing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.CheckP2pMailingLocalServiceImpl}.
 * </p>
 *
 * @author TLS
 ...
 * @generated
 */
public abstract class CheckP2pMailingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CheckP2pMailingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.CheckP2pMailingLocalServiceUtil} to access the check p2p mailing local service.
	 */
	...
	public CheckP2pMailing addCheckP2pMailing(CheckP2pMailing checkP2pMailing)
		throws SystemException {
		checkP2pMailing.setNew(true);

		return checkP2pMailingPersistence.update(checkP2pMailing, false);
	}
	 ...
	 */
	public CheckP2pMailing createCheckP2pMailing(long checkP2pId) {
		return checkP2pMailingPersistence.create(checkP2pId);
	}
	...
	public CheckP2pMailing deleteCheckP2pMailing(long checkP2pId)
		throws PortalException, SystemException {
		return checkP2pMailingPersistence.remove(checkP2pId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CheckP2pMailing deleteCheckP2pMailing(
		CheckP2pMailing checkP2pMailing) throws SystemException {
		return checkP2pMailingPersistence.remove(checkP2pMailing);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CheckP2pMailing.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return checkP2pMailingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return checkP2pMailingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CheckP2pMailing fetchCheckP2pMailing(long checkP2pId)
		throws SystemException {
		return checkP2pMailingPersistence.fetchByPrimaryKey(checkP2pId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CheckP2pMailing getCheckP2pMailing(long checkP2pId)
		throws PortalException, SystemException {
		return checkP2pMailingPersistence.findByPrimaryKey(checkP2pId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return checkP2pMailingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CheckP2pMailing> getCheckP2pMailings(int start, int end)
		throws SystemException {
		return checkP2pMailingPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCheckP2pMailingsCount() throws SystemException {
		return checkP2pMailingPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CheckP2pMailing updateCheckP2pMailing(
		CheckP2pMailing checkP2pMailing) throws SystemException {
		return updateCheckP2pMailing(checkP2pMailing, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public CheckP2pMailing updateCheckP2pMailing(
		CheckP2pMailing checkP2pMailing, boolean merge)
		throws SystemException {
		checkP2pMailing.setNew(false);

		return checkP2pMailingPersistence.update(checkP2pMailing, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.CheckP2pMailing",
			checkP2pMailingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = checkP2pMailingPersistence.getDataSource();
	...
	private CheckP2pMailingLocalServiceClpInvoker _clpInvoker = new CheckP2pMailingLocalServiceClpInvoker();
}