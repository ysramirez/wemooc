...
public class LearningTypePersistenceImpl extends BasePersistenceImpl<LearningType>
	...
	public List<LearningType> findByUuid(String uuid, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LearningType learningType : list) {
				if (!Validator.equals(uuid, learningType.getUuid())) {
					list = null;
	...
	public LearningType findByUuid_First(String uuid,
		...
		throws NoSuchLearningTypeException, SystemException {
		LearningType learningType = fetchByUuid_First(uuid, orderByComparator);
	 ...
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching learning type, or <code>null</code> if a matching learning type could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public LearningType fetchByUuid_First(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public LearningType findByUuid_Last(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchLearningTypeException, SystemException {
		LearningType learningType = fetchByUuid_Last(uuid, orderByComparator);
	 ...
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching learning type, or <code>null</code> if a matching learning type could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public LearningType fetchByUuid_Last(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
