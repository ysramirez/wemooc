...
/**
 * The base implementation of the audit entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.AuditEntryLocalServiceImpl}.
 * </p>
 *
 * @author TLS
...
public abstract class AuditEntryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.AuditEntryLocalServiceUtil} to access the audit entry local service.
	 */
	...
	public AuditEntry addAuditEntry(AuditEntry auditEntry)
		...
		return auditEntryPersistence.update(auditEntry, false);
	}
	...
	public AuditEntry deleteAuditEntry(long auditId)
	...
	public AuditEntry fetchAuditEntry(long auditId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AuditEntry getAuditEntry(long auditId)
		throws PortalException, SystemException {
	...
	public AuditEntry updateAuditEntry(AuditEntry auditEntry)
		throws SystemException {
		return updateAuditEntry(auditEntry, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AuditEntry updateAuditEntry(AuditEntry auditEntry, boolean merge)
		throws SystemException {
		auditEntry.setNew(false);

		return auditEntryPersistence.update(auditEntry, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.AuditEntry",
