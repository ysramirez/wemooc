...
public class CourseIndexer extends BaseIndexer {
	...
	protected Document doGetDocument(Object obj) throws Exception {
		...
		contentSinAcentos=contentSinAcentos.replace('�', 'a');
		contentSinAcentos=contentSinAcentos.replace('�', 'e');
		contentSinAcentos=contentSinAcentos.replace('�', 'i');
		contentSinAcentos=contentSinAcentos.replace('�', 'o');
		contentSinAcentos=contentSinAcentos.replace('�', 'u');
