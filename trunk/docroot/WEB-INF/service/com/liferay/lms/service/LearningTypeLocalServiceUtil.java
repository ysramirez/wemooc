...
public class LearningTypeLocalServiceUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.lms.model.LearningType deleteLearningType(
		long typeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteLearningType(typeId);
	}
	...
	*/
	public static com.liferay.lms.model.LearningType deleteLearningType(
		com.liferay.lms.model.LearningType learningType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteLearningType(learningType);
	}
	...
	*/
	...
	public static LearningTypeLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof LearningTypeLocalService) {
				_service = (LearningTypeLocalService)invokableLocalService;
			}
			else {
				_service = new LearningTypeLocalServiceClp(invokableLocalService);
			}
