...
public class TestAnswerServiceClp implements TestAnswerService {
	public TestAnswerServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getTestAnswersByQuestionId";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "getTestAnswer";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "modTestAnswer";

		_methodParameterTypes5 = new String[] { "com.liferay.lms.model.TestAnswer" };

		_methodName6 = "addTestAnswer";
	...
	public java.util.List<com.liferay.lms.model.TestAnswer> getTestAnswersByQuestionId(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { questionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.liferay.lms.model.TestAnswer getTestAnswer(long answerId)
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { answerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
