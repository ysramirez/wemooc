...
public class ClpSerializer {
	...
	public static Object translateInputLearningType(BaseModel<?> oldModel) {
		LearningTypeClp oldClpModel = (LearningTypeClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getLearningTypeRemoteModel();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.liferay.lms.NoSuchLearningTypeException")) {
			return new com.liferay.lms.NoSuchLearningTypeException();
		}
	...
	public static Object translateOutputLearningType(BaseModel<?> oldModel) {
		...
		newModel.setLearningTypeRemoteModel(oldModel);
