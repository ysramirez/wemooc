...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			CheckP2pMailingServiceUtil.clearService();
			...
			P2pActivityServiceUtil.clearService();
			P2pActivityCorrectionsLocalServiceUtil.clearService();

			P2pActivityCorrectionsServiceUtil.clearService();
			SurveyResultLocalServiceUtil.clearService();

			SurveyResultServiceUtil.clearService();
