 ...
 * @author TLS
 */
public class CompetenceClp extends BaseModelImpl<Competence>
	implements Competence {
	public CompetenceClp() {
	}
	...
	public BaseModel<?> getCompetenceRemoteModel() {
		return _competenceRemoteModel;
	}

	public void setCompetenceRemoteModel(BaseModel<?> competenceRemoteModel) {
		_competenceRemoteModel = competenceRemoteModel;
	}
	...
	public Competence toEscapedModel() {
		return (Competence)Proxy.newProxyInstance(Competence.class.getClassLoader(),
			new Class[] { Competence.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		CompetenceClp clone = new CompetenceClp();
	...
	public boolean equals(Object obj) {
		...
		CompetenceClp competence = null;

		try {
			competence = (CompetenceClp)obj;
		}
