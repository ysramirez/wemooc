...
public class TaskOnlineAssetRenderer extends BaseAssetRenderer {
	...
	public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest,
		...
		PortletURL portletURL = liferayPortletResponse.createActionURL( "onlinetaskactivity_WAR_liferaylmsportlet");
		portletURL.setParameter("javax.portlet.action", "edit");
			
		portletURL.setParameter("mvcPath", "/html/onlinetaskactivity/admin/edit.jsp");
		portletURL.setParameter("jspPage", "/html/onlinetaskactivity/admin/edit.jsp"); 
	...
	public String getURLViewInContext(
		...
		PortletURL portletURL = liferayPortletResponse.createRenderURL("onlinetaskactivity_WAR_liferaylmsportlet");
