...
public class TaskOfflineAssetRenderer extends BaseAssetRenderer {
	...
	public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest,
		...
		PortletURL portletURL = liferayPortletResponse.createActionURL( "offlinetaskactivity_WAR_liferaylmsportlet");
		portletURL.setParameter("javax.portlet.action", "edit");
			
		portletURL.setParameter("mvcPath", "/html/offlinetaskactivity/admin/edit.jsp");
		portletURL.setParameter("jspPage", "/html/offlinetaskactivity/admin/edit.jsp"); 
