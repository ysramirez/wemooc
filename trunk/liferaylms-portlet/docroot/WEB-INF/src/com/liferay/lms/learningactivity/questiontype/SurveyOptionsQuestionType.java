 ...
 *
 */
public class SurveyOptionsQuestionType extends OptionsQuestionType {
	...
	public String getTitle(Locale locale) {
		return LanguageUtil.get(locale, "surveyoptions.title");
	}

	public String getDescription(Locale locale) {
		return LanguageUtil.get(locale, "surveyoptions.description");
	}
