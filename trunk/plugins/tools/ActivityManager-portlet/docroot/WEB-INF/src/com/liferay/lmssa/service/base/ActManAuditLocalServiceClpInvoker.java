...
public class ActManAuditLocalServiceClpInvoker {
	public ActManAuditLocalServiceClpInvoker() {
		...
		_methodName53 = "countBycompanyId";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return ActManAuditLocalServiceUtil.addActManAudit((com.liferay.lmssa.model.ActManAudit)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return ActManAuditLocalServiceUtil.deleteActManAudit((com.liferay.lmssa.model.ActManAudit)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return ActManAuditLocalServiceUtil.updateActManAudit((com.liferay.lmssa.model.ActManAudit)arguments[0]);
		}
		...
		if (_methodName52.equals(name) &&
			...
			return ActManAuditLocalServiceUtil.findBycompanyId(((Long)arguments[0]).longValue(),
				((Integer)arguments[1]).intValue(),
				((Integer)arguments[2]).intValue());
		}
		...
		if (_methodName53.equals(name) &&
			...
			return ActManAuditLocalServiceUtil.countBycompanyId(((Long)arguments[0]).longValue());
		}
