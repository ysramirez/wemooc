 ...
 * @author je03042
 */
public class MailJobLocalServiceClp implements MailJobLocalService {
	public MailJobLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName21 = "getNotProcessedMailJobs";

		_methodParameterTypes21 = new String[] {  };

		_methodName22 = "getMailJobsInGroupId";
	...
	public com.tls.liferaylms.mail.model.MailJob addMailJob(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(mailJob) });
		}
		catch (Throwable t) {
		...
		return (com.tls.liferaylms.mail.model.MailJob)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.tls.liferaylms.mail.model.MailJob createMailJob(long idJob) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { idJob });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.tls.liferaylms.mail.model.MailJob deleteMailJob(long idJob)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { idJob });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.tls.liferaylms.mail.model.MailJob fetchMailJob(long idJob)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { idJob });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.tls.liferaylms.mail.model.MailJob getMailJob(long idJob)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { idJob });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.tls.liferaylms.mail.model.MailJob updateMailJob(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName16,
					...
					new Object[] { ClpSerializer.translateInput(mailJob), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.tls.liferaylms.mail.model.MailJob addMailJob(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					ClpSerializer.translateInput(conditionClassName),
						
					ClpSerializer.translateInput(conditionClassPK),
						
					ClpSerializer.translateInput(conditionStatus),
						
					ClpSerializer.translateInput(dateClassName),
						
					ClpSerializer.translateInput(dateClassPK),
						
					ClpSerializer.translateInput(dateShift),
						
					ClpSerializer.translateInput(referenceState),
