...
public class ExecActivity extends MVCPortlet 
{
	...
	public void editanswer(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		//tenga un nombre �nico, y las test de ordenar usan FCKEditor por lo que, temporalmente dejamos la comprobaci�n de ambos campos hasta que todo se pase a FCKEditor.
