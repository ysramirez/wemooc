...
<div id="addNewQuestion" style="display:none;">
	...
	<aui:form name="afm" action="<%=addanswerURL%>" method="post">
		...
		//<!--
			Liferay.provide(
		        window,
		        '<portlet:namespace />onChangeTextNewAnswer',
		        function(val) {
		        	var A = AUI();
		...
		<aui:input type="hidden" cssClass="input-comment" name="feedbackCorrect" label="feedback">
						...
						<div class="leftSideAnswer">
							...
							<aui:form name="<%=\"afm_\"+testanswer.getAnswerId() %>" action="<%=editanswerURL %>" method="post">
								...
								//<!--
									Liferay.provide(
								        window,
								        '<portlet:namespace />onChangeTextAnswer_<%=testanswer.getAnswerId() %>',
								        function(val) {
								        	var A = AUI();
								...
								<aui:input type="hidden" name="feedbackCorrect" label="feedback" value="<%=testanswer.getFeedbackCorrect() %>">
									<aui:validator name="maxLength">300</aui:validator>
								</aui:input>
