...
SCORM_1_3.TerminationRequestProcessResult.createEnum(
		'SCORM_1_3.TerminationRequestProcessResult', false);
...
SCORM_1_3.EndSequencingSession.createEnum('SCORM_1_3.EndSequencingSession',
		false);
...
SCORM_1_3.ActivityTreeNode.prototype = {
	...
	updateSequencingState : function() {
		...
		var $6 = 'cmi.score.max';
		var $7 = 0;
		if (this.$13.getObjectivesCount() > 0
				&& this.$13.getPrimaryObjective() === this.$13
						.getObjectiveByIndex(0)) {
			if (!this.$16($0)) {
		...
		while ($A) {
			if ((this.$13.completionSetByContent || this.$16($0))) {
				$8
						.set_attemptCompletionStatus(this.getDataTreeValue($0) === 'completed');
				$8
						.set_attemptProgressStatus(this.getDataTreeValue($0) !== 'unknown');
				if (this.$13.status === $8) {
			...
			if ((this.$13.objectiveSetByContent || this.$16($2))) {
				$8
						.set_objectiveSatisfiedStatus(this.getDataTreeValue($2) === 'passed');
				$8
						.set_objectiveProgressStatus(this.getDataTreeValue($2) !== 'unknown');
				if (this.$13.status === $8) {
			...
			if (this.$16($1)) {
				...
				$8.set_attemptCompletionAmount(parseFloat(this
						.getDataTreeValue($1)));
			}
			if (this.$16($3)) {
				$8.set_objectiveMeasureStatus(true);
				$8.set_objectiveNormalizedMeasure(parseFloat(this
						.getDataTreeValue($3)));
	...
	getDataTreeValue : function(dataElement) {
		if (dataElement === 'cmi.completion_status'
				...
				if (this.getDataTreeValue('cmi.credit') === 'credit') {
					if (this.getDataTreeValue('cmi.completion_threshold') != null) {
						if (this.getDataTreeValue('cmi.progress_measure') != null) {
							if (parseFloat(this
									.getDataTreeValue('cmi.progress_measure')) >= parseFloat(this
									.getDataTreeValue('cmi.completion_threshold'))) {
								return 'completed';
							} else {
								return 'incomplete';
							}
					...
					if (this.getDataTreeValue('cmi.scaled_passing_score') != null) {
						if (this.getDataTreeValue('cmi.score.scaled') != null) {
							if (parseFloat(this
									.getDataTreeValue('cmi.score.scaled')) >= parseFloat(this
									.getDataTreeValue('cmi.scaled_passing_score'))) {
								return 'passed';
							} else {
								return 'failed';
							}
	...
	$16 : function($p0) {
		if ($p0 === 'cmi.completion_status' || $p0 === 'cmi.success_status') {
			if (this.getDataTreeValue('cmi.mode') === 'normal'
					&& this.getDataTreeValue('cmi.credit') === 'credit') {
				if ($p0 === 'cmi.completion_status'
						&& this.getDataTreeValue('cmi.completion_threshold') != null) {
					return false;
				} else if ($p0 === 'cmi.success_status'
						&& this.getDataTreeValue('cmi.scaled_passing_score') != null) {
					return false;
				}
			}
		}
...
SCORM_1_3.ActivityTree = function(selectedOrganizationIdentifier,
		resumeAllIdentifier, storedStatuses, globalObjectives) {
	this.$20 = {};
	this.$26 = [];
	this.$32 = 0;
	this.$3E = 0;
	...
	if (!isNullOrUndefined(globalObjectives)
			&& Object.getKeyCount(globalObjectives) > 0) {
		this.$25 = true;
...
SCORM_1_3.ActivityTree.prototype = {
	...
	evaluateDeliveryRequest : function(validationNavigationRequest) {
		...
		try {
			...
			if (this.getActiveAPI() != null) {
				this.getActiveAPI().getActivityTreeNode()
						.updateSequencingState();
			}
	...
	isValidNavigationRequest : function(validationNavigationRequest,
			isExpectTheSameChoice) {
		var $0 = false;
		if (validationNavigationRequest.startsWith('jump.')
				|| validationNavigationRequest.startsWith('choice.')) {
			$0 = isExpectTheSameChoice;
		}
		var $1 = this.evaluateDeliveryRequest(validationNavigationRequest);
		return $1 != null
				&& (($0) ? $1.getIdentifier() === this.get_$39() : true);
	},
	requestNavigation : function(navigationRequest) {
		if (!this.$24 && this.getActiveAPI() != null
				&& this.getActiveAPI().isInitAttempted()
				&& !this.getActiveAPI().isFinishAttempted()) {
			this.getActiveAPI().getActivityTreeNode().setDataTreeValue(
					'adl.nav.request', navigationRequest, false);
			this
					.onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(
							null, 3));
		} else {
			API_BASE.LOG.displayMessage('Process Navigation: '
					+ navigationRequest, '0', null);
			this.set_$45(null);
			this.set_$2D(null);
			this.set_$3B(null);
			this.set_$35(null);
			...
			if (navigationRequest === 'start') {
				...
				var $0 = navigationRequest.match(new RegExp('^{target=('
						+ API_BASE.BaseUtils.ncName + ')}jump$'));
				if ($0 != null && $0.length >= 2 && !isNullOrUndefined($0[1])
						&& $0[1].length > 0) {
					this.set_$29(14);
					this.set_$39($0[1]);
				}
			} else if (navigationRequest.endsWith('}choice')) {
				var $1 = navigationRequest.match(new RegExp('^{target=('
						+ API_BASE.BaseUtils.ncName + ')}choice$'));
				if ($1 != null && $1.length >= 2 && !isNullOrUndefined($1[1])
						&& $1[1].length > 0) {
					this.set_$29(8);
					this.set_$39($1[1]);
				}
	...
	$47 : function() {
		...
		if (this.get_$31() !== 0) {
			this.$4A();
			if (this.get_$31() === 1) {
				this.onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(
						null, 4));
				return;
			}
			if (this.get_$3F() === 1) {
	...
	$48 : function() {
		...
		case 2:
			if (this.get_$2B() == null) {
				...
				API_BASE.LOG.displayMessage(
						'[NB.2.1] Navigation Request Process', this.get_$45(),
						this.$46(this.get_$45()));
				return;
			}
		case 3:
			if (this.get_$2B() == null) {
				if (this.get_$3D() != null) {
					...
					API_BASE.LOG.displayMessage(
							'[NB.2.1] Navigation Request Process', this
									.get_$45(), this.$46(this.get_$45()));
					return;
				}
			} else {
				this.set_$29(0);
		...
		case 4:
			...
			if (this.get_$2B() !== this.getOrganization()
					&& this.get_$2B().getParentSequencing().flow) {
		...
		case 5:
			...
			if (this.get_$2B() !== this.getOrganization()) {
				if (this.get_$2B().getParentSequencing().flow
						&& !this.get_$2B().getParentSequencing().forwardOnly) {
					if (this.get_$2B().get_isActive()) {
						this.set_$29(1);
						this.set_$2F(3);
						this.set_$31(6);
		...
		case 6:
			...
			API_BASE.LOG.displayMessage('[NB.2.1] Navigation Request Process',
					this.get_$45(), this.$46(this.get_$45()));
			return;
		case 7:
			this.set_$29(0);
			this.set_$2F(0);
		...
		case 8:
			...
			if ($0 != null) {
				if ($0 === this.getOrganization()
						|| $0.getParentSequencing().choice) {
					if (this.get_$2B() == null) {
						this.set_$29(1);
						this.set_$2F(0);
						this.set_$31(7);
					...
					if (this.get_$2B().get_isActive()
							&& !this.get_$2B().getSequencing().choiceExit) {
						this.set_$29(0);
						this.set_$2F(0);
						this.set_$31(0);
						this.set_$37(null);
		...
		API_BASE.LOG.displayMessage('[NB.2.1] Navigation Request Process', this
				.get_$45(), this.$46(this.get_$45()));
	},
	$49 : function() {
		if (this.get_$2B() == null) {
			...
			API_BASE.LOG.displayMessage('[TB.2.3] Termination Request Process',
					this.get_$45(), this.$46(this.get_$45()));
			return;
		}
		if ((this.get_$2F() === 3 || this.get_$2F() === 5)
				&& !this.get_$2B().get_isActive()) {
			this.set_$2F(1);
			this.set_$31(0);
			...
			while ($0) {
				...
				if (this.get_$2F() === 8) {
					if (this.get_$2B() !== this.getOrganization()) {
						...
						API_BASE.LOG.displayMessage(
								'[TB.2.3] Termination Request Process', this
										.get_$45(), this.$46(this.get_$45()));
						return;
					}
				} else {
		...
		case 7:
			...
			var $1 = this.get_$3D().getPath(this.getOrganization(), true, true,
					false);
			if ($1.length === 0) {
				this.set_$2F(1);
				this.set_$31(0);
				...
				API_BASE.LOG.displayMessage(
						'[TB.2.3] Termination Request Process', this.get_$45(),
						this.$46(this.get_$45()));
				return;
			}
		...
		case 5:
			...
			return;
		case 6:
			var $2 = this.get_$2B().getPath(this.getOrganization(), true, true,
					false);
			if ($2.length === 0) {
				this.set_$2F(1);
				this.set_$31(0);
	...
	$4A : function() {
		...
		API_BASE.LOG.displayMessage('[SB.2.12] Sequencing Request Process',
				this.get_$45(), this.$46(this.get_$45()));
	},
	$4B : function() {
		if (this.get_$2B() != null) {
			...
			API_BASE.LOG.displayMessage(
					'[SB.2.6] Resume All Sequencing Request Process', this
							.get_$45(), this.$46(this.get_$45()));
			return;
		}
		if (this.get_$3D() == null) {
	...
	$4D : function() {
		if (this.get_$2B() == null) {
			...
			API_BASE.LOG.displayMessage(
					'[SB.2.10] Retry Sequencing Request Process', this
							.get_$45(), this.$46(this.get_$45()));
			return;
		}
	...
	$4E : function() {
		if (this.get_$2B() == null) {
			...
			API_BASE.LOG.displayMessage(
					'[SB.2.7] Continue Sequencing Request Process', this
							.get_$45(), this.$46(this.get_$45()));
			return;
		}
		if (this.get_$2B() !== this.getOrganization()) {
	...
	$4F : function() {
		if (this.get_$2B() == null) {
			...
			API_BASE.LOG.displayMessage(
					'[SB.2.8] Previous Sequencing Request Process', this
							.get_$45(), this.$46(this.get_$45()));
			return;
		}
		if (this.get_$2B() !== this.getOrganization()) {
	...
	$50 : function() {
		if (this.get_$37() == null) {
			...
			API_BASE.LOG.displayMessage(
					'[SB.2.9] Choice Sequencing Request Process', this
							.get_$45(), this.$46(this.get_$45()));
			return;
		}
		var $0 = this.get_$37().getPath(this.getOrganization(), true, true,
				true);
		...
		while ($enum1.moveNext()) {
			...
			var $4 = this.$57($3.getSequencing().getConditionRulesForAction(
					'hiddenFromChoice'), $3);
			if ($4 != null) {
				this.set_$2D(null);
		...
		if (this.get_$2B() === this.get_$37()) {
		} else if (this.get_$2B() != null
				&& this.get_$2B().isSibling(this.get_$37())) {
			...
			while ($enum3.moveNext()) {
				...
				if (!$A.get_isActive()
						&& ($A !== $1 && $A.getSequencing().constrainedChoiceConsiderations_preventActivation)) {
					this.set_$2D(null);
			...
			if ($F != null) {
				...
				this.$52($F, $13);
				var $14 = this.get_$3B();
				if ((!$14.getParentSequencing().flow || !this.get_$37()
						.getParentSequencing().flow)
						&& this.get_$37() !== $14 && this.get_$37() !== $F) {
					this.set_$2D(null);
			...
			if (($11 !== this.get_$37() && $11 !== this.get_$37().getParent())
					|| ($11 === this.get_$37().getParent() && $11 !== this
							.get_$2B())) {
				...
				while ($enum6.moveNext()) {
					...
					if (!$15.get_isActive()
							&& ($15 !== $1 && $15.getSequencing().constrainedChoiceConsiderations_preventActivation)) {
						this.set_$2D(null);
						this.set_$45('SB.2.9-6');
						API_BASE.LOG.displayMessage(
								'[SB.2.9] Choice Sequencing Request Process',
				...
				while ($enum7.moveNext()) {
					...
					if (!$17.get_isActive()
							&& ($17 !== $1 && $17.getSequencing().constrainedChoiceConsiderations_preventActivation)) {
						this.set_$2D(null);
						this.set_$45('SB.2.9-6');
						API_BASE.LOG.displayMessage(
								'[SB.2.9] Choice Sequencing Request Process',
	...
	$51 : function($p0, $p1) {
		if ($p1) {
			var $0 = this.$57($p0.getSequencing().getConditionRulesForAction(
					'stopForwardTraversal'), $p0);
			if ($0 != null) {
				this.set_$43(false);
				this.set_$45('SB.2.4-1');
				API_BASE.LOG.displayMessage(
						'[SB.2.4] Choice Activity Traversal Subprocess', this
								.get_$45(), this.$46(this.get_$45()));
				return this.get_$43();
			}
			this.set_$43(true);
	...
	$54 : function() {
		if (this.get_$2B() == null) {
			...
			API_BASE.LOG.displayMessage(
					'[SB.2.13] Jump Sequencing Request Process',
					this.get_$45(), this.$46(this.get_$45()));
			return;
		}
		this.set_$2D(this.get_$37());
			...
			if ($p0.getSequencing().tracked) {
				if (!$p0.get_isSuspended()) {
					if (!$p0.getSequencing().completionSetByContent) {
						$p0.getSequencing().status
								.set_attemptProgressStatus(true);
						$p0.getSequencing().status
								.set_attemptCompletionStatus(true);
					}
	...
	$56 : function() {
		var $0 = this.get_$2B().getParent().getPath(this.getOrganization(),
				true, true, true);
		var $1 = null;
		var $enum1 = $0.getEnumerator();
		while ($enum1.moveNext()) {
			var $2 = $enum1.get_current();
			var $3 = this.$57($2.getSequencing().getConditionRulesForAction(
					'exit'), $2);
			if ($3 != null) {
				$1 = $2;
				break;
	...
	$58 : function($p0, $p1) {
		...
		for ( var $key2 in $dict1) {
			...
			if ($6 === 'satisfied') {
				$4 = ($9.get_objectiveProgressStatus() && $9
						.get_objectiveSatisfiedStatus()) ? 'true' : 'false';
			...
			if ($6 === 'objectiveMeasureGreaterThan') {
				$4 = ($9.get_objectiveMeasureStatus() && $9
						.get_objectiveNormalizedMeasure() > parseFloat($8)) ? 'true'
						: 'false';
			...
			if ($6 === 'completed') {
				$4 = ($9.get_attemptProgressStatus() && $9
						.get_attemptCompletionStatus()) ? 'true' : 'false';
				if ($p1.isCompletedbymeasure()
						&& !$9.attemptCompletionAmountStatus) {
					$4 = 'unknown';
				}
			...
			if ($6 === 'activityProgressKnown') {
				$4 = ($9.activityProgressStatus && $9
						.get_attemptProgressStatus()) ? 'true' : 'false';
			}
			if ($6 === 'attempted') {
				$4 = ($9.activityProgressStatus && $9.attemptCount > 0) ? 'true'
						: 'false';
			...
			if ($6 === 'attemptLimitExceeded') {
				$4 = ($9.activityProgressStatus
						&& $p1.getSequencing().limitConditions_attemptControl && $9.attemptCount >= parseInt($p1
						.getSequencing().limitConditions_attemptLimit)) ? 'true'
						: 'false';
				if (!$9.activityProgressStatus) {
					$4 = 'unknown';
				}
	...
	$59 : function($p0) {
		...
		var $0 = this.$57(this.get_$2B().getSequencing().postConditionRules,
				this.get_$2B());
		if ($0 != null) {
				...
				if ($6.getSequencing().tracked) {
					...
					if ($7 != null) {
						...
						if ($7.status.get_objectiveMeasureStatus()) {
							$0 += $7.status.get_objectiveNormalizedMeasure()
									* $6.getSequencing().rollupObjectiveMeasureWeight;
							$1 = true;
						}
					} else {
						return;
		...
		while ($enum1.moveNext()) {
			...
			if ($3.getSequencing().tracked) {
				...
				if ($3.getSequencing().status.attemptCompletionAmountStatus) {
					$0 += $3.getSequencing().status
							.get_attemptCompletionAmount()
							* $3.getProgressweight();
					$1 = true;
				}
			}
	...
	$5E : function($p0) {
		this.$5F($p0);
		if (!$p0.getSequencing().getPrimaryObjective().satisfiedByMeasure
				&& !$p0.getSequencing().status.objectiveSatisfiedStatusFromGlobal
				&& !$p0.getSequencing().objectiveSetByContent) {
			this.$60($p0);
		}
	},
	$5F : function($p0) {
		...
		if ($0 != null) {
			if ($0.satisfiedByMeasure) {
				if (!$0.status.get_objectiveMeasureStatus()) {
					...
					if (!$p0.get_isActive()
							|| ($p0.get_isActive() && $p0.getSequencing().rollupConsiderations_measureSatisfactionIfActive)) {
	...
	$60 : function($p0) {
		if ($p0.getSequencing()
				.getConditionRollupRulesForAction('notSatisfied').length === 0
				&& $p0.getSequencing().getConditionRollupRulesForAction(
						'satisfied').length === 0) {
			var $2 = {};
	...
	$62 : function($p0, $p1) {
		...
		if ($p1 === 'satisfied' || $p1 === 'notSatisfied') {
			if ($p0.getSequencing().rollupObjectiveSatisfied) {
				$1 = true;
				if (($p1 === 'satisfied' && $p0.getSequencing().rollupConsiderations_requiredForSatisfied === 'ifNotSuspended')
						|| ($p1 === 'notSatisfied' && $p0.getSequencing().rollupConsiderations_requiredForNotSatisfied === 'ifNotSuspended')) {
					if (!$0.activityProgressStatus
							|| ($0.attemptCount > 0 && $p0.get_isSuspended())) {
						$1 = false;
					}
				} else {
					if (($p1 === 'satisfied' && $p0.getSequencing().rollupConsiderations_requiredForSatisfied === 'ifAttempted')
							|| ($p1 === 'notSatisfied' && $p0.getSequencing().rollupConsiderations_requiredForNotSatisfied === 'ifAttempted')) {
						if (!$0.activityProgressStatus || $0.attemptCount === 0) {
							$1 = false;
						}
					} else {
						if (($p1 === 'satisfied' && $p0.getSequencing().rollupConsiderations_requiredForSatisfied === 'ifNotSkipped')
								|| ($p1 === 'notSatisfied' && $p0
										.getSequencing().rollupConsiderations_requiredForNotSatisfied === 'ifNotSkipped')) {
							if (this.$57($p0.getSequencing()
									.getConditionRulesForAction('skip'), $p0) != null) {
								$1 = false;
							}
						}
					}
		...
		if ($p1 === 'completed' || $p1 === 'incomplete') {
			if ($p0.getSequencing().rollupProgressCompletion) {
				$1 = true;
				if (($p1 === 'completed' && $p0.getSequencing().rollupConsiderations_requiredForCompleted === 'ifNotSuspended')
						|| ($p1 === 'incomplete' && $p0.getSequencing().rollupConsiderations_requiredForIncomplete === 'ifNotSuspended')) {
					if (!$0.activityProgressStatus
							|| ($0.attemptCount > 0 && $p0.get_isSuspended())) {
						$1 = false;
					}
				} else {
					if (($p1 === 'completed' && $p0.getSequencing().rollupConsiderations_requiredForCompleted === 'ifAttempted')
							|| ($p1 === 'incomplete' && $p0.getSequencing().rollupConsiderations_requiredForIncomplete === 'ifAttempted')) {
						if (!$0.activityProgressStatus || $0.attemptCount === 0) {
							$1 = false;
						}
					} else {
						if (($p1 === 'completed' && $p0.getSequencing().rollupConsiderations_requiredForCompleted === 'ifNotSkipped')
								|| ($p1 === 'incomplete' && $p0.getSequencing().rollupConsiderations_requiredForIncomplete === 'ifNotSkipped')) {
							if (this.$57($p0.getSequencing()
									.getConditionRulesForAction('skip'), $p0) != null) {
								$1 = false;
							}
	...
	$63 : function($p0, $p1) {
		...
		for ( var $key2 in $dict1) {
			...
			var $7 = ($3.value)['operator'] === 'not';
			if ($6 === 'satisfied') {
				$4 = ($5.get_objectiveProgressStatus() && $5
						.get_objectiveSatisfiedStatus()) ? 'true' : 'false';
			...
			if ($6 === 'completed') {
				$4 = ($5.get_attemptProgressStatus() && $5
						.get_attemptCompletionStatus()) ? 'true' : 'false';
			...
			if ($6 === 'attempted') {
				$4 = ($5.activityProgressStatus && $5.attemptCount > 0) ? 'true'
						: 'false';
				if (!$5.activityProgressStatus) {
					$4 = 'unknown';
				}
			...
			if ($6 === 'attemptLimitExceeded') {
				$4 = ($5.activityProgressStatus
						&& $p0.getSequencing().limitConditions_attemptControl && $5.attemptCount >= parseInt($p0
						.getSequencing().limitConditions_attemptLimit)) ? 'true'
						: 'false';
				if (!$5.activityProgressStatus) {
					$4 = 'unknown';
	...
	$64 : function($p0) {
		if ($p0.isCompletedbymeasure()) {
			this.$65($p0);
		} else if (!$p0.getSequencing().completionSetByContent
				&& !$p0.getSequencing().status.attemptCompletionStatusFromGlobal) {
			this.$66($p0);
		}
	},
	$65 : function($p0) {
		...
		if ($p0.isCompletedbymeasure()) {
			if (!$p0.getSequencing().status.attemptCompletionAmountStatus) {
				...
				if ($p0.getSequencing().status.get_attemptCompletionAmount() >= $p0
					...
					$p0.getSequencing().status.set_attemptProgressStatus(true);
					$p0.getSequencing().status
							.set_attemptCompletionStatus(false);
				}
			}
		} else {
			$p0.getSequencing().status.set_attemptProgressStatus(false);
	...
	$66 : function($p0) {
		if ($p0.getSequencing().getConditionRollupRulesForAction('incomplete').length === 0
				&& $p0.getSequencing().getConditionRollupRulesForAction(
						'completed').length === 0) {
			var $1 = {};
	...
	$67 : function() {
		if (!this.get_$2D().isLeaf()) {
			...
			API_BASE.LOG.displayMessage('[DB.1.1] Delivery Request Process',
					this.get_$45(), this.$46(this.get_$45()));
			return false;
		}
		var $0 = this.get_$2D().getPath(this.getOrganization(), true, true,
				true);
		if ($0.length === 0) {
		...
		while ($enum1.moveNext()) {
			...
			if ($2) {
				...
				API_BASE.LOG.displayMessage(
						'[DB.1.1] Delivery Request Process', this.get_$45(),
						this.$46(this.get_$45()));
				return false;
			}
		}
	...
	$68 : function() {
		if (this.get_$2B() != null && this.get_$2B().get_isActive()) {
			this.set_$45('DB.2-1');
			API_BASE.LOG.displayMessage(
					'[DB.2] Content Delivery Environment Process', this
							.get_$45(), this.$46(this.get_$45()));
			return;
		}
		if (this.get_$2B() != null) {
		...
		if (!this.get_$2D().getSequencing().tracked) {
			this.get_$2D().getSequencing().status
					.set_attemptProgressStatus(false);
			this.get_$2D().getSequencing().status
					.set_objectiveProgressStatus(false);
		}
		this.set_$45(null);
		if (!this.$24) {
			this.$22 = this.getClonedGlobalObjectives();
			this.$23 = this.$77();
			this.onEventSCO(new API_BASE.BaseActivityTreeNodeEventArgs(this
					.get_$2D(), 2));
		}
	},
	$69 : function($p0) {
		...
		if ($p1 === 1) {
			...
			if ($p0.isLeaf() || !$p3) {
				...
				if ($p0.getChildrensCount() > 0) {
					...
					API_BASE.LOG.displayMessage(
							'[SB.2.1] Flow Tree Traversal Subprocess', this
									.get_$45(), this.$46(this.get_$45()));
					return;
				}
			}
	...
	$6D : function($p0, $p1, $p2) {
		if (!$p0.getParentSequencing().flow) {
			...
			API_BASE.LOG.displayMessage(
					'[SB.2.2] Flow Activity Traversal Subprocess', this
							.get_$45(), this.$46(this.get_$45()));
			return;
		}
		var $0 = this.$57($p0.getSequencing()
				.getConditionRulesForAction('skip'), $p0);
		if ($0 != null) {
	...
	$6F : function($p0) {
		...
		if ($p0.getSequencing().limitConditions_attemptControl) {
			if ($p0.getSequencing().status.activityProgressStatus
					&& $p0.getSequencing().status.attemptCount >= parseInt($p0
							.getSequencing().limitConditions_attemptLimit)) {
				$0 = true;
				return $0;
			}
		}
	...
	findCommonParent : function(currentNode, targetNode) {
		if (currentNode == null || currentNode === this.getOrganization()
				|| targetNode == null || targetNode === this.getOrganization()) {
	...
	initByManifest : function(manifestPath, imsmanifest) {
		...
		var $7 = API_BASE.BaseUtils.getChildNodeByName($0,
		...
		if (!isNullOrUndefined(this.$17) && this.$17.length > 0) {
			...
			while ($enum1.moveNext()) {
				...
				var $C = API_BASE.BaseUtils
						.getXMLNodeAttribut($B, 'identifier');
				if ($C === this.$17) {
					$8 = true;
		...
		for ( var $key3 in $dict2) {
			...
			if ($E.getSequencing().randomizationTiming !== 'never'
					|| $E.getSequencing().selectionTiming !== 'never') {
				this.$72($E);
			}
		}
					...
					try {
						if ($15['readSatisfiedStatus']) {
							if ($11.objectiveProgressStatus) {
								...
								$14.status
										.set_objectiveProgressStatus($11.objectiveProgressStatus);
								$14.status
										.set_objectiveSatisfiedStatus($11.satisfiedStatus);
							} else {
						...
						if ($15['readNormalizedMeasure']) {
							...
							if ($11.measureStatus) {
								...
								$14.status
										.set_objectiveMeasureStatus($11.measureStatus);
								$14.status
										.set_objectiveNormalizedMeasure($11.normalizedMeasure);
							} else {
						...
						if ($15['readProgressMeasure']) {
							...
							$14.status
									.set_attemptCompletionAmount($11.progressMeasure);
						}
						if ($15['readCompletionStatus']) {
							$14.status.attemptCompletionStatusFromGlobal = true;
							$14.status.activityProgressStatus = true;
							$14.status
									.set_attemptCompletionStatus($11.completionStatus);
							$14.status
									.set_attemptProgressStatus($11.completionProgressStatus);
						}
						if (!$F.contains($14.getSequencing()
								.getActivityTreeNode())) {
	...
	$73 : function($p0, $p1, $p2, $p3, $p4, $p5) {
		...
		if (!$p5) {
			...
			if ($1 != null && $1.length > 0 && !isNullOrUndefined($p2)
					&& $p2.length >= 1) {
				var $enum1 = $p2.getEnumerator();
				while ($enum1.moveNext()) {
					var $6 = $enum1.get_current();
					var $7 = API_BASE.BaseUtils.getXMLNodeAttribut($6,
							'identifier');
					if ($7 != null && $7 === $1) {
						$4 = API_BASE.BaseUtils.getXMLNodeAttribut($6,
								'scormType');
						...
						var $8 = API_BASE.BaseUtils.getXMLNodeAttribut($6,
								'base');
						if ($8 != null && $8.length > 0
								&& !$2.startsWith('http://')
								&& !$2.startsWith('https://')) {
							if (!$8.endsWith('/')) {
								$8 += '/';
						...
						var $9 = API_BASE.BaseUtils.getXMLNodeAttribut($p1,
								'parameters');
			...
			$3 = API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'isvisible') == null
					|| API_BASE.BaseUtils.getXMLNodeAttribut($p1, 'isvisible') === 'true';
		} else {
			this.$1E = API_BASE.BaseUtils.getXMLNodeAttribut($p1,
					'sharedDataGlobalToSystem') == null
					|| API_BASE.BaseUtils.getXMLNodeAttribut($p1,
							'sharedDataGlobalToSystem') === 'true';
			this.$1F = API_BASE.BaseUtils.getXMLNodeAttribut($p1,
					'objectivesGlobalToSystem') == null
					|| API_BASE.BaseUtils.getXMLNodeAttribut($p1,
		...
		for ( var $A = 0; $A < $p1.childNodes.length; $A++) {
			...
			var $B = API_BASE.BaseUtils.getBaseName($p1.childNodes[$A])
					.toLowerCase();
			...
			if ($B === 'title') {
				...
				$5
						.setCompletedbymeasure(API_BASE.BaseUtils
								.getXMLNodeAttribut($p1.childNodes[$A],
										'completedByMeasure') != null
								&& API_BASE.BaseUtils.getXMLNodeAttribut(
										$p1.childNodes[$A],
										'completedByMeasure') === 'true');
				if (API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A],
						'minProgressMeasure') != null) {
					$5.setMinprogressmeasure(parseFloat(API_BASE.BaseUtils
							.getXMLNodeAttribut($p1.childNodes[$A],
									'minProgressMeasure')));
				}
				if (API_BASE.BaseUtils.getXMLNodeAttribut($p1.childNodes[$A],
						'progressWeight') != null) {
					$5.setProgressweight(parseFloat(API_BASE.BaseUtils
							.getXMLNodeAttribut($p1.childNodes[$A],
									'progressWeight')));
				}
			} else if ($B === 'data') {
				...
				for ( var $E = 0; $E < $p1.childNodes[$A].childNodes.length; $E++) {
					...
					var $11 = API_BASE.BaseUtils.getXMLNodeAttribut($F,
							'targetID');
					if ($11.length <= 0) {
						continue;
					}
					...
					var $12 = true;
					if (API_BASE.BaseUtils.getXMLNodeAttribut($F,
							'readSharedData') != null) {
						$12 = API_BASE.BaseUtils.getXMLNodeAttribut($F,
								'readSharedData') === 'true';
					}
					var $13 = true;
					if (API_BASE.BaseUtils.getXMLNodeAttribut($F,
							'writeSharedData') != null) {
						$13 = API_BASE.BaseUtils.getXMLNodeAttribut($F,
				...
				var $14 = API_BASE.BaseUtils.getChildNodeByName(
						$p1.childNodes[$A], 'navigationInterface');
				if (!isNullOrUndefined($14)) {
					...
					for ( var $16 = 0; $16 < $14.childNodes.length; $16++) {
						...
						var $18 = API_BASE.BaseUtils.getBaseName($17)
								.toLowerCase();
						if ($18 !== 'hidelmsui'
								|| isNullOrUndefined(API_BASE.BaseUtils
										.getText($17))) {
							continue;
						}
						var $19 = API_BASE.BaseUtils.getText($17).trim()
								.toLowerCase();
						if (!$15.contains($19)) {
							$15.add($19);
						}
		...
		if ($5.getSequencing().getPrimaryObjective().mapInfos == null) {
			if (!isNullOrUndefined(this.$21[$5.getIdentifier()])) {
				$5.getSequencing().status
						.setStatusStateFromDictionary(this.$21[$5
								.getIdentifier()]);
			}
		}
	},
	$74 : function($p0, $p1, $p2) {
		...
		if ($0 != null && $p2 != null) {
			for ( var $2 = 0; $2 < $p2.childNodes.length; $2++) {
				...
				var $3 = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p2.childNodes[$2], 'ID');
				if ($0 === $3) {
		...
		while ($enum1.moveNext()) {
			var $4 = $enum1.get_current();
			var $5 = API_BASE.BaseUtils.getChildNodeByName($4,
					'primaryObjective');
			if ($5 != null) {
				$p0.getSequencing().createObjectives(
						API_BASE.BaseUtils
								.getXMLNodeAttribut($5, 'objectiveID'));
				var $6 = API_BASE.BaseUtils.getXMLNodeAttribut($5,
						'satisfiedByMeasure');
				if ($6 === 'true') {
					$p0.getSequencing().getPrimaryObjective().satisfiedByMeasure = true;
					var $7 = API_BASE.BaseUtils.getChildNodeByName($5,
							'minNormalizedMeasure');
					var $8 = '1.0';
					if ($7 != null
							&& API_BASE.BaseUtils.getText($7).trim().length > 0) {
						$8 = API_BASE.BaseUtils.getText($7).trim();
					}
					$p0.getSequencing().getPrimaryObjective().minNormalizedMeasure = parseFloat($8);
				}
				this.$75(API_BASE.BaseUtils.getChildSiblingsByName($5,
						'mapInfo'), $p0.getSequencing().getPrimaryObjective());
				break;
			}
		}
		for ( var $9 = 0; $9 < $p1.childNodes.length; $9++) {
			...
			var $A = API_BASE.BaseUtils.getBaseName($p1.childNodes[$9])
					.toLowerCase();
			if ($A === 'controlmode') {
				var $B = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'choice');
				$p0.getSequencing().choice = $B === 'true' || $B == null;
				var $C = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'choiceExit');
				$p0.getSequencing().choiceExit = $C === 'true' || $C == null;
				var $D = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'flow');
				$p0.getSequencing().flow = $D === 'true';
				var $E = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'forwardOnly');
				$p0.getSequencing().forwardOnly = $E === 'true';
				var $F = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'useCurrentAttemptObjectiveInfo');
				$p0.getSequencing().useCurrentAttemptObjectiveInfo = $F === 'true'
						|| $F == null;
				var $10 = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'useCurrentAttemptProgressInfo');
				$p0.getSequencing().useCurrentAttemptProgressInfo = $10 === 'true'
						|| $10 == null;
			} else if ($A === 'objectives'
					&& $p0.getSequencing().getPrimaryObjective() != null) {
				var $11 = API_BASE.BaseUtils.getChildSiblingsByName(
						$p1.childNodes[$9], 'objective');
				var $enum2 = $11.getEnumerator();
				while ($enum2.moveNext()) {
					var $12 = $enum2.get_current();
					var $13 = API_BASE.BaseUtils.getXMLNodeAttribut($12,
							'objectiveID');
					if ($13 != null) {
						$13 = SCORM_1_3.Utils.removeWhiteSpaces(decodeURI($13
								.trim()));
					}
					...
					if ($13 != null && $14 != null) {
						...
						$15 = $p0.getSequencing().addObjective(
								$p0.getSequencing().getObjectivesCount(), $13);
					}
					var $16 = API_BASE.BaseUtils.getXMLNodeAttribut($12,
							'satisfiedByMeasure');
					if ($16 === 'true') {
						$15.satisfiedByMeasure = true;
						var $17 = API_BASE.BaseUtils.getChildNodeByName($12,
								'minNormalizedMeasure');
						var $18 = '1.0';
						if ($17 != null
								&& API_BASE.BaseUtils.getText($17).trim().length > 0) {
							$18 = API_BASE.BaseUtils.getText($17).trim();
						}
						$15.minNormalizedMeasure = parseFloat($18);
					}
					this.$75(API_BASE.BaseUtils.getChildSiblingsByName($12,
							'mapInfo'), $15);
				}
			} else if ($A === 'randomizationcontrols') {
				var $19 = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'randomizationTiming');
				if (!isNullOrUndefined($19)) {
					$p0.getSequencing().randomizationTiming = $19;
				}
				var $1A = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'selectCount');
				if (!isNullOrUndefined($1A) && $1A.length > 0) {
					$p0.getSequencing().selectCount = parseInt($1A);
				}
				var $1B = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'reorderChildren');
				if (!isNullOrUndefined($1B)) {
					$p0.getSequencing().reorderChildren = $1B === 'true';
				}
				var $1C = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'selectionTiming');
				if (!isNullOrUndefined($1C)) {
					$p0.getSequencing().selectionTiming = $1C;
				}
			} else if ($A === 'deliverycontrols') {
				var $1D = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'tracked');
				$p0.getSequencing().tracked = $1D == null || $1D === 'true';
				$p0.getSequencing().manifestCompletionSetByContent = API_BASE.BaseUtils
						.getXMLNodeAttribut($p1.childNodes[$9],
								'completionSetByContent') === 'true';
				$p0.getSequencing().manifestObjectiveSetByContent = API_BASE.BaseUtils
						.getXMLNodeAttribut($p1.childNodes[$9],
								'objectiveSetByContent') === 'true';
				$p0.getSequencing().completionSetByContent = $p0
						.getSequencing().manifestCompletionSetByContent;
				$p0.getSequencing().objectiveSetByContent = $p0.getSequencing().manifestObjectiveSetByContent;
			} else if ($A === 'sequencingrules') {
				$p0.getSequencing().preConditionRules = this.$76(
						$p1.childNodes[$9], 'preConditionRule');
				$p0.getSequencing().postConditionRules = this.$76(
						$p1.childNodes[$9], 'postConditionRule');
				$p0.getSequencing().exitConditionRules = this.$76(
						$p1.childNodes[$9], 'exitConditionRule');
			} else if ($A === 'rolluprules') {
				if (!isNullOrUndefined($p0.getSequencing().rollupRules)) {
					$p0.getSequencing().rollupRules.clear();
				}
				var $1E = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'rollupObjectiveSatisfied');
				var $1F = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'rollupProgressCompletion');
				var $20 = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'objectiveMeasureWeight');
				$p0.getSequencing().rollupObjectiveSatisfied = ($1E === 'false') ? false
						: true;
				$p0.getSequencing().rollupProgressCompletion = ($1F === 'false') ? false
						: true;
				$p0.getSequencing().rollupObjectiveMeasureWeight = parseFloat(($20 == null || $20.length === 0) ? '1.0000'
						: $20);
				var $21 = API_BASE.BaseUtils.getChildSiblingsByName(
						$p1.childNodes[$9], 'rollupRule');
				var $enum3 = $21.getEnumerator();
				while ($enum3.moveNext()) {
					var $22 = $enum3.get_current();
					var $23 = API_BASE.BaseUtils.getChildNodeByName($22,
							'rollupAction');
					var $24 = API_BASE.BaseUtils.getChildNodeByName($22,
							'rollupConditions');
					if ($24 == null || $23 == null) {
						continue;
					}
					var $25 = {};
					var $26 = API_BASE.BaseUtils.getXMLNodeAttribut($22,
							'childActivitySet');
					$25['childActivitySet'] = ($26 == null || $26.length === 0) ? 'all'
							: $26;
					var $27 = API_BASE.BaseUtils.getXMLNodeAttribut($22,
							'minimumCount');
					$25['minimumCount'] = ($27 == null || $27.length === 0) ? '0'
							: $27;
					var $28 = API_BASE.BaseUtils.getXMLNodeAttribut($22,
							'minimumPercent');
					$25['minimumPercent'] = ($28 == null || $28.length === 0) ? '0.0000'
							: $28;
					var $29 = API_BASE.BaseUtils.getXMLNodeAttribut($24,
							'conditionCombination');
					$25['action'] = API_BASE.BaseUtils.getXMLNodeAttribut($23,
							'action');
					$25['conditionCombination'] = ($29 == null) ? 'any' : $29;
					var $2A = API_BASE.BaseUtils.getChildSiblingsByName($24,
							'rollupCondition');
					var $2B = 0;
					var $enum4 = $2A.getEnumerator();
					while ($enum4.moveNext()) {
						var $2C = $enum4.get_current();
						var $2D = API_BASE.BaseUtils.getXMLNodeAttribut($2C,
								'operator');
						$25['rule_' + $2B] = {
							condition : API_BASE.BaseUtils.getXMLNodeAttribut(
									$2C, 'condition'),
				...
				$p0.getSequencing().limitConditions_attemptLimit = API_BASE.BaseUtils
						.getXMLNodeAttribut($p1.childNodes[$9], 'attemptLimit');
				if ($p0.getSequencing().limitConditions_attemptLimit != null
						&& parseInt($p0.getSequencing().limitConditions_attemptLimit) >= 0) {
					$p0.getSequencing().limitConditions_attemptControl = true;
				}
				$p0.getSequencing().limitConditions_attemptAbsoluteDurationLimit = API_BASE.BaseUtils
						.getXMLNodeAttribut($p1.childNodes[$9],
				...
				$p0.getSequencing().constrainedChoiceConsiderations_preventActivation = API_BASE.BaseUtils
						.getXMLNodeAttribut($p1.childNodes[$9],
								'preventActivation') === 'true';
				$p0.getSequencing().constrainedChoiceConsiderations_constrainChoice = API_BASE.BaseUtils
						.getXMLNodeAttribut($p1.childNodes[$9],
								'constrainChoice') === 'true';
			} else if ($A === 'rollupconsiderations') {
				var $2E = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'requiredForSatisfied');
				$p0.getSequencing().rollupConsiderations_requiredForSatisfied = ($2E == null) ? 'always'
						: $2E;
				var $2F = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'requiredForNotSatisfied');
				$p0.getSequencing().rollupConsiderations_requiredForNotSatisfied = ($2F == null) ? 'always'
						: $2F;
				var $30 = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'requiredForCompleted');
				$p0.getSequencing().rollupConsiderations_requiredForCompleted = ($30 == null) ? 'always'
						: $30;
				var $31 = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'requiredForIncomplete');
				$p0.getSequencing().rollupConsiderations_requiredForIncomplete = ($31 == null) ? 'always'
						: $31;
				var $32 = API_BASE.BaseUtils.getXMLNodeAttribut(
						$p1.childNodes[$9], 'measureSatisfactionIfActive');
	...
	$75 : function($p0, $p1) {
		...
		while ($enum1.moveNext()) {
			var $1 = $enum1.get_current();
			var $2 = API_BASE.BaseUtils.getXMLNodeAttribut($1,
					'targetObjectiveID');
			if ($2 == null) {
				continue;
			}
			$2 = SCORM_1_3.Utils.removeWhiteSpaces(decodeURI($2.trim()));
			var $3 = API_BASE.BaseUtils.getXMLNodeAttribut($1,
					'readSatisfiedStatus');
			var $4 = API_BASE.BaseUtils.getXMLNodeAttribut($1,
					'readNormalizedMeasure');
			var $5 = API_BASE.BaseUtils.getXMLNodeAttribut($1,
					'writeSatisfiedStatus');
			var $6 = API_BASE.BaseUtils.getXMLNodeAttribut($1,
			...
			var $A = API_BASE.BaseUtils.getXMLNodeAttribut($1,
					'readCompletionStatus');
			var $B = API_BASE.BaseUtils.getXMLNodeAttribut($1,
					'readProgressMeasure');
			...
			var $F = API_BASE.BaseUtils.getXMLNodeAttribut($1,
					'writeCompletionStatus');
			var $10 = API_BASE.BaseUtils.getXMLNodeAttribut($1,
	...
	$76 : function($p0, $p1) {
		...
		while ($enum1.moveNext()) {
			...
			var $4 = API_BASE.BaseUtils
					.getChildNodeByName($2, 'ruleConditions');
			if ($4 == null || $3 == null) {
				continue;
			}
			var $5 = API_BASE.BaseUtils.getXMLNodeAttribut($4,
					'conditionCombination');
			var $6 = {};
			$6['action'] = API_BASE.BaseUtils.getXMLNodeAttribut($3, 'action');
			$6['conditionCombination'] = ($5 == null) ? 'all' : $5;
			var $7 = API_BASE.BaseUtils.getChildSiblingsByName($4,
					'ruleCondition');
			var $8 = 0;
			...
			while ($enum2.moveNext()) {
				...
				var $B = API_BASE.BaseUtils.getXMLNodeAttribut($9,
						'referencedObjective');
				if ($B != null) {
					$B = SCORM_1_3.Utils
							.removeWhiteSpaces(decodeURI($B.trim()));
				}
				$6['rule_' + $8] = {
					referencedObjective : $B,
					measureThreshold : API_BASE.BaseUtils.getXMLNodeAttribut(
							$9, 'measureThreshold'),
					condition : API_BASE.BaseUtils.getXMLNodeAttribut($9,
							'condition'),
...
SCORM_1_3.ActivityTreeNodeSequencing.prototype = {
	...
	createObjectives : function(primaryObjectiveID) {
		...
		if (primaryObjectiveID != null && primaryObjectiveID.length > 0) {
			this.$1['primaryObjective'] = this.addObjective(this
					.getObjectivesCount(), primaryObjectiveID);
		} else {
			this.$1['primaryObjective'] = new SCORM_1_3.SequencingObjective(
					this);
		}
...
SCORM_1_3.SequencingObjectiveStatus = function(sequencingObjective) {
	...
	if (this.$0 != null) {
		this.$1 = this.$0.getSequencing().getActivityTreeNode().getRoot()
				.getGlobalObjectives();
	}
}
SCORM_1_3.SequencingObjectiveStatus.prototype = {
	...
	setStatusStateToDictionary : function() {
		...
		$0['objectiveNormalizedMeasure'] = this
				.get_objectiveNormalizedMeasure();
	...
	updateGlobalObjective : function() {
		if (this.$0 == null
				|| this.$1 == null
				|| !this.$0.getSequencing().tracked
				|| this.$0.mapInfos == null
				|| !this.$0.getSequencing().getActivityTreeNode().getRoot().isGlobalObjectivesUpdateAvailable) {
			return;
		}
		var $0 = this.$0.getSequencing().getActivityTreeNode().getRoot()
				.getRollupSet();
		var $1 = this.$0;
		...
		for ( var $key2 in $dict1) {
			...
			if ($5) {
				$4.objectiveProgressStatus = $1.status
						.get_objectiveProgressStatus();
			...
			if ($B) {
				$4.completionProgressStatus = $1.status
						.get_attemptProgressStatus();
			...
			while ($enum3.moveNext()) {
				...
				var $E = $D.mapInfos[$3];
				if ($1.mapInfos == null || isNullOrUndefined($E)
						|| !$D.getSequencing().tracked) {
					continue;
				}
				var $F = this.$0.getSequencing().getActivityTreeNode()
						.getRoot().isGlobalObjectivesUpdateAvailable;
				...
				try {
					...
					if ($5 && $E['readSatisfiedStatus']) {
						...
						if ($4.objectiveProgressStatus) {
							...
							$D.status
									.set_objectiveProgressStatus($4.objectiveProgressStatus);
							$D.status
									.set_objectiveSatisfiedStatus($4.satisfiedStatus);
						} else {
					...
					if ($6 && $E['readNormalizedMeasure']) {
						...
						if ($4.measureStatus) {
							...
							$D.status
									.set_objectiveMeasureStatus($4.measureStatus);
							$D.status
									.set_objectiveNormalizedMeasure($4.normalizedMeasure);
						} else {
					...
					if ($A && $E['readProgressMeasure']) {
						...
						$D.status
								.set_attemptCompletionAmount($4.progressMeasure);
					}
					if ($B && $E['readCompletionStatus']) {
						...
						$D.status
								.set_attemptCompletionStatus($4.completionStatus);
						$D.status
								.set_attemptProgressStatus($4.completionProgressStatus);
					}
					if ($10
							&& !$0.contains($D.getSequencing()
									.getActivityTreeNode())) {
...
SCORM_1_3.API_1484_11_LIB = function(activityTreeNode) {
	...
	this.$17 = '^previous$|^continue$|^exit$|^exitAll$|^abandon$|^abandonAll$|^suspendAll$|^{target='
			+ API_BASE.BaseUtils.ncName
			+ '}choice$|^{target='
			+ API_BASE.BaseUtils.ncName + '}jump$|^_none_$';
	this.$18 = '^unknown$|^true$|^false$';
	this.$19 = '^previous$|^continue$|^choice.{target='
			+ API_BASE.BaseUtils.ncName + '}$|^jump.{target='
			+ API_BASE.BaseUtils.ncName + '}$';
	...
	this.$2A['cmi.completion_threshold'] = {
		defaultvalue : (activityTreeNode.isCompletedbymeasure()) ? activityTreeNode
				.getMinprogressmeasure()
				: null,
		mod : 'r'
	};
	...
	this.$2A['cmi.launch_data'] = {
		defaultvalue : (activityTreeNode.getDatafromlms() == null) ? null
				: activityTreeNode.getDatafromlms(),
		mod : 'r'
	};
	...
	this.$2A['cmi.max_time_allowed'] = {
		defaultvalue : (activityTreeNode.getSequencing() != null) ? activityTreeNode
				.getSequencing().limitConditions_attemptAbsoluteDurationLimit
				: null,
		mod : 'r'
	};
	this.$2A['cmi.mode'] = {
	...
	this.$2A['cmi.scaled_passing_score'] = {
		defaultvalue : (activityTreeNode.getSequencing() != null
				&& activityTreeNode.getSequencing().getPrimaryObjective() != null && activityTreeNode
				.getSequencing().getPrimaryObjective().satisfiedByMeasure) ? activityTreeNode
				.getSequencing().getPrimaryObjective().minNormalizedMeasure
				: null,
		format : this.$C,
		range : this.$23,
		mod : 'r'
	...
	this.$2A['cmi.time_limit_action'] = {
		defaultvalue : (activityTreeNode.getTimelimitaction() == null) ? 'continue,no message'
				: activityTreeNode.getTimelimitaction(),
		mod : 'r'
	};
		...
		if ($4.key.match(new RegExp(/\.n\./)) == null) {
			if (isUndefined(this.$2C.getDataTreeValue($4.key))) {
				if (!isUndefined((Type.safeCast($4.value, Object))['defaultvalue'])) {
					this.$2C.setDataTreeValue($4.key, (Type.safeCast($4.value,
	...
	if (this.$2C.getRoot() != null
			&& this.$2C.getRoot().isShareddataglobaltosystem()) {
		this.$2B = this.$2C.getRoot().getADLCPData();
	} else {
		this.$2B = this.$2C.getADLCPData();
	}
	if (this.$2B != null) {
		this.$2C.setDataTreeValue('adl.data._count', Object.getKeyCount(
				this.$2B).toString(), false);
		var $dict5 = this.$2B;
		for ( var $key6 in $dict5) {
			...
			if (isUndefined(this.$2C.getDataTreeValue('adl.data.' + $6 + '.id'))) {
				this.$2C.setDataTreeValue('adl.data.' + $6 + '.id', $5.key,
						false);
				this.$2C.setDataTreeValue('adl.data.' + $6 + '.store',
						($5.value)['store'], false);
			}
		}
	}
	if (activityTreeNode.getSequencing() != null) {
		if (this.$2C.getSequencing().getPrimaryObjective() != null
				&& this.$2C.getDataTreeValue('cmi.objectives._count') === '0') {
			for ( var $7 = 0; $7 < this.$2C.getSequencing()
					.getObjectivesCount(); $7++) {
				var $8 = this.$2C.getSequencing().getObjectiveByIndex($7);
				this.$33('cmi.objectives', $7.toString());
				this.$2C.setDataTreeValue('cmi.objectives.' + $7 + '.id',
						$8.objectiveID, false);
				var $9 = $8.status;
				if ($9.get_objectiveProgressStatus()) {
					this.$2C.setDataTreeValue('cmi.objectives.' + $7
							+ '.success_status', ($9
							.get_objectiveSatisfiedStatus()) ? 'passed'
							: 'failed', false);
				}
				if ($9.get_objectiveMeasureStatus()) {
					this.$2C
							.setDataTreeValue('cmi.objectives.' + $7
									+ '.score.scaled', $9
									.get_objectiveNormalizedMeasure()
									.toString(), false);
				}
				if ($9.get_attemptProgressStatus()) {
					this.$2C.setDataTreeValue('cmi.objectives.' + $7
							+ '.completion_status', ($9
							.get_attemptCompletionStatus()) ? 'completed'
							: 'incomplete', false);
				}
				if ($9.attemptCompletionAmountStatus) {
					this.$2C.setDataTreeValue('cmi.objectives.' + $7
							+ '.progress_measure', $9
							.get_attemptCompletionAmount().toString(), false);
				}
			}
			this.$2C.setDataTreeValue('cmi.objectives._count', this.$2C
					.getSequencing().getObjectivesCount().toString(), false);
		}
	}
...
SCORM_1_3.API_1484_11_LIB.prototype = {
	...
	Terminate : function(param) {
		...
		if (param === '') {
			if (this.$2D && (!this.$2E)) {
				API_BASE.LOG.displayMessage('Terminate with param: \'' + param
						+ '\'', this.$30, this.$32(this.$30));
				this.$2D = false;
				this.$2E = true;
				...
				if (this.$2C.getDataTreeValue('cmi.session_time') === (this.$2A['cmi.session_time'])['defaultvalue']) {
					this.$2C.setDataTreeValue('cmi.session_time',
							SCORM_1_3.Utils.getTimeInterval(new Date()
									.getTime()
									- this.$31), false);
				}
				this.$2C.setDataTreeValue('cmi.total_time', SCORM_1_3.Utils
						.addTime(this.$2C.getDataTreeValue('cmi.total_time'),
								this.$2C.getDataTreeValue('cmi.session_time')),
						false);
				if (this.$2C.getRoot() != null) {
					if (this.$2C.getRoot().isShareddataglobaltosystem()
							&& this.$2B != null) {
						var $dict1 = this.$2B;
						for ( var $key2 in $dict1) {
							var $2 = {
							...
							var $3 = this.$2C.getDataTreeValue('adl.data.'
									+ ($2.value)['n'] + '.store');
				...
				if (this.$2C.getRoot() != null) {
					...
					for ( var $key4 in $dict3) {
						...
						var $7 = $6.value;
						$4[$6.key] = $7.getSequencing().status
								.setStatusStateToDictionary();
					}
					this.$2C.getRoot().onEventSCO(
							new API_BASE.BaseActivityTreeNodeEventArgs(
									this.$2C, 0));
	...
	GetValue : function(element) {
				...
				if (!isUndefined(this.$2A[$1])) {
					if ((Type.safeCast(this.$2A[$1], Object))['mod'] !== 'w') {
						...
						if ((Type.safeCast(this.$2A[$1], Object))['mod2'] === 'shared') {
							var $2 = element.split('.');
							if (this.$2B != null && !isNullOrUndefined($2)
									&& $2.length > 3) {
								var $dict1 = this.$2B;
								for ( var $key2 in $dict1) {
									var $3 = {
						...
						if (this.$30 === '0') {
							...
							if (!isNullOrUndefined($5)) {
								this.$30 = '0';
								API_BASE.LOG.displayMessage('GetValue '
										+ element + ', \'' + $5 + '\'',
										this.$30, this.$32(this.$30));
								return $5;
							} else if (isNull($5)) {
					...
					if ($1.substr($1.length - $6.length, $1.length) === $6) {
						...
						if (element.substr(0, $8.length) === $8) {
							if (element.substr($8.length).match(
									new RegExp(this.$19)) == null) {
								this.$30 = '301';
							} else {
								this.$30 = '0';
								var $9 = 'unknown';
								if (this.$2C.getRoot() != null) {
									$9 = (this.$2C.getRoot()
											.isValidNavigationRequest(element
													.substr($8.length), true)) ? 'true'
											: 'false';
								}
								API_BASE.LOG.displayMessage('GetValue '
										+ element + ', \'' + $9 + '\'', '0',
		...
		API_BASE.LOG.displayMessage('GetValue ' + element + ', \'\'', this.$30,
				this.$32(this.$30));
		return '';
	},
	SetValue : function(element, value) {
			...
			if (element !== '') {
				...
				if (!isUndefined(this.$2A[$1])) {
					if ((Type.safeCast(this.$2A[$1], Object))['mod'] !== 'r') {
						...
						if ((Type.safeCast(this.$2A[$1], Object))['mod2'] === 'shared') {
							var $3 = element.split('.');
							if (this.$2B != null && !isNullOrUndefined($3)
									&& $3.length > 3) {
								var $dict1 = this.$2B;
								for ( var $key2 in $dict1) {
									var $4 = {
						...
						if (this.$30 === '0') {
							var $6 = value.match($0);
							if (($6 != null)
									&& (($6.join('').length > 0) || (value.length === 0))) {
								if ($2 === this.$7 || $2 === this.$6) {
									if ($6.length >= 3
											&& !isNullOrUndefined($6[2])
											&& $6[2].length > 0
											&& $6[2] !== 'x'
											&& $6[2] !== 'i'
											&& isUndefined(this.$0[$6[2]
													.toLowerCase()])) {
										this.$30 = '406';
									}
								} else if ($2 === this.$5) {
									if ($6.length >= 2
											&& !isNullOrUndefined($6[1])
											&& $6[1].length > 0
											&& $6[1] !== 'x'
											&& $6[1] !== 'i'
											&& isUndefined(this.$0[$6[1]
													.toLowerCase()])) {
										this.$30 = '406';
									}
								} else if ($2 === this.$8) {
									if ($6.length >= 8
											&& parseInt($6[7]) > SCORM_1_3.Utils
													.daysInMonth(
															parseInt($6[4]),
															parseInt($6[1]))) {
										this.$30 = '406';
								...
								if (this.$30 === '0' && element !== $1) {
									...
									var $9 = $7[0];
									var $A = false;
									for ( var $B = 1; ($B < $7.length - 1)
											&& (this.$30 === '0'); $B++) {
										var $C = $7[$B];
										var $D = $7[$B + 1].match(new RegExp(
												/^\d+$/));
												...
												if (isUndefined(this.$2C
													...
													this.$2C
															.setDataTreeValue(
																	...
																	'0', false);
													$A = true;
												} else if (parseInt($7[$B + 1]) === parseInt(this.$2C
														.getDataTreeValue($8
																+ '.' + $C
																+ '._count'))) {
													$A = true;
									...
									if (this.$30 === '0') {
										...
										if ($A) {
											...
											case 'cmi.objectives.n.id':
												if (!this.$34(element, $9,
														value)) {
													if ($7[$7.length - 2] === this.$2C
															.getDataTreeValue($9
																	+ '._count')) {
														this
																.$33(
											...
											case 'cmi.interactions.n.correct_responses.n.pattern':
												if (!isUndefined(this.$2C
													...
													if ($7[$7.length - 2] === this.$2C
														...
														if (isUndefined((this.$29[$E])['limit'])
																|| parseInt(this.$2C
																		.getDataTreeValue($9
																				+ '._count')) < parseInt((this.$29[$E])['limit'])) {
															this.$30 = this
																	.$36(
																			element,
																			$E,
											...
											case 'cmi.objectives.n.id':
												if (this.$2C
														.getDataTreeValue(element) !== value) {
													this.$30 = '351';
											...
											case 'cmi.interactions.n.correct_responses.n.pattern':
												var $10 = $8.split('.');
												var $11 = 'cmi.interactions.'
														+ $10[2];
												var $12 = this.$2C
														.getDataTreeValue($11
																+ '.type');
												if (isNullOrUndefined(this.$2C
														.getDataTreeValue($11
																+ '.type'))) {
													this.$30 = '408';
												} else {
													if (isUndefined((this.$29[$12])['limit'])
															|| parseInt(this.$2C
																	.getDataTreeValue($9
																			+ '._count')) <= parseInt((this.$29[$12])['limit'])) {
														this.$30 = this.$36(
																element, $12,
																value,
																this.$29[$12]);
														if (this.$30 === '0'
																&& (this.$29[$12])['duplicate']
																&& this
																		.$35(
																				element,
																				$9,
								...
								if (this.$30 === '0') {
									if (!isUndefined((this.$2A[$1])['range'])) {
										...
										this.$2C.setDataTreeValue(element,
												value, true);
										this.$30 = '0';
										API_BASE.LOG.displayMessage('SetValue '
												+ element + ', \'' + value
												+ '\'', this.$30, this
												.$32(this.$30));
										return 'true';
		...
		API_BASE.LOG.displayMessage('SetValue ' + element + ', \'' + value
				+ '\'', this.$30, this.$32(this.$30));
		return 'false';
	},
	Commit : function(param) {
		...
		if (param === '') {
			if (this.$2D && (!this.$2E)) {
				...
				API_BASE.LOG.displayMessage('Commit with param: \'' + param
						+ '\'', this.$30, this.$32(this.$30));
				return 'true';
			} else {
				if (this.$2E) {
	...
	GetLastError : function() {
		API_BASE.LOG.displayMessage('GetLastError, Error Code: ' + this.$30,
				'0', null);
		return this.$30;
	},
	GetErrorString : function(param) {
		if (param !== '') {
			...
			if (!isNullOrUndefined($0)) {
				API_BASE.LOG.displayMessage('GetErrorString with param: \''
						+ param + '\', Error String: ' + $0, '0', null);
				return $0;
			}
		}
		API_BASE.LOG.displayMessage('GetErrorString with param: \'' + param
				+ '\', No error string found!', '0', null);
		return '';
	},
	$32 : function($p0) {
		var $0 = {};
	...
	GetDiagnostic : function(param) {
		...
		if (param === '') {
			param = this.$30;
			if (this.$2F !== '') {
				API_BASE.LOG.displayMessage('GetDiagnostic with param: \''
						+ param + '\' Diagnostic: ' + this.$2F, '0', null);
				return this.$2F;
			}
		}
		API_BASE.LOG.displayMessage('GetDiagnostic with param: \'' + param
				+ '\'', '0', null);
		return this.GetErrorString(param);
	},
	$33 : function($p0, $p1) {
		if ($p1 === this.$2C.getDataTreeValue($p0 + '._count')) {
			this.$2C.setDataTreeValue($p0 + '._count', (parseInt(this.$2C
					.getDataTreeValue($p0 + '._count')) + 1).toString(), false);
			var $dict1 = this.$2A;
			for ( var $key2 in $dict1) {
				var $0 = {
					key : $key2,
						...
						this.$2C
								.setDataTreeValue(
										$p0
												...
												+ $p1
												+ $0.key
														.substr(($p0 + '.n.').length - 1),
										(Type.safeCast($0.value, Object))['defaultvalue'],
										false);
					} else {
						this.$2C.setDataTreeValue($p0 + '.' + $p1
								+ $0.key.substr(($p0 + '.n.').length - 1),
								null, false);
					}
				}
			}
	...
	$34 : function($p0, $p1, $p2) {
		...
		for ( var $2 = 0; ($2 < parseInt($1)) && (!$0); $2++) {
			if (($p1 + '.' + $2 + '.id' !== $p0)
					&& (this.$2C.getDataTreeValue($p1 + '.' + $2 + '.id') === $p2)) {
				$0 = true;
			}
		}
		return $0;
	...
	$35 : function($p0, $p1, $p2) {
		...
		for ( var $2 = 0; ($2 < parseInt($1)) && (!$0); $2++) {
			if (($p1 + '.' + $2 + '.pattern' !== $p0)
					&& (this.$2C.getDataTreeValue($p1 + '.' + $2 + '.pattern') === $p2)) {
				$0 = true;
			}
		}
		return $0;
			...
			for ( var $2 = 0; ($2 < $0.length) && (this.$30 === '0'); $2++) {
				...
				if (!isNullOrUndefined($p3['delimiter2'])) {
					...
					if ($p1 === 'numeric' && ($p3['delimiter']).length > 0) {
						...
						var $7 = $0[$2].match($1);
						if (($7 == null && $p2 !== '')
								|| ($7 == null && ($p1 === 'true-false' || $p1 === 'likert'))) {
							return '406';
						}
						if ($0[$2] !== '' && $p3['unique']) {
							for ( var $8 = 0; $8 < $2; $8++) {
		...
		while ($3 === '0' && $5 != null && $5.length > 2) {
			...
			case 'lang':
				...
				if ($6 != null && $6.join('').length > 0) {
					if ($6.length >= 3 && !isNullOrUndefined($6[2])
							&& $6[2] !== 'x' && $6[2] !== 'i'
							&& isUndefined(this.$0[$6[2].toLowerCase()])) {
						$3 = '406';
					}
				} else {
					$3 = '406';
...
API_1484_11.Initialize = function(param) {
	return API_1484_11.$0.Initialize(param);
}
...
SCORM_1_3.ActivityTreeNode.createClass('SCORM_1_3.ActivityTreeNode', null,
		API_BASE.IActivityTreeNode);
SCORM_1_3.ActivityTree.createClass('SCORM_1_3.ActivityTree',
		SCORM_1_3.ActivityTreeNode, API_BASE.IActivityTree);
SCORM_1_3.ActivityTreeNodeSequencing
		.createClass('SCORM_1_3.ActivityTreeNodeSequencing');
SCORM_1_3.SequencingObjectiveStatus
		.createClass('SCORM_1_3.SequencingObjectiveStatus');
...
SCORM_1_3.API_1484_11_LIB.createClass('SCORM_1_3.API_1484_11_LIB', null,
		API_BASE.IAPI);
