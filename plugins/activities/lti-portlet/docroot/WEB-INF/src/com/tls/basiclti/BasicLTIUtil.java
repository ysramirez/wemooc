...
package com.tls.basiclti;

import static com.tls.basiclti.BasicLTIConstants.CUSTOM_PREFIX;
import static com.tls.basiclti.BasicLTIConstants.LTI_MESSAGE_TYPE;
import static com.tls.basiclti.BasicLTIConstants.LTI_VERSION;
import static com.tls.basiclti.BasicLTIConstants.TOOL_CONSUMER_INSTANCE_CONTACT_EMAIL;
import static com.tls.basiclti.BasicLTIConstants.TOOL_CONSUMER_INSTANCE_DESCRIPTION;
import static com.tls.basiclti.BasicLTIConstants.TOOL_CONSUMER_INSTANCE_GUID;
import static com.tls.basiclti.BasicLTIConstants.TOOL_CONSUMER_INSTANCE_NAME;
import static com.tls.basiclti.BasicLTIConstants.TOOL_CONSUMER_INSTANCE_URL;
...
public class BasicLTIUtil {
	...
	public static String postLaunchHTML(
			final Map<String, String> cleanProperties, String endpoint, boolean debug,Locale locale, boolean iframe) {
		...
		if (debug) {
			...
			text.append("</a>");
			text.append("<script language=\"javascript\">function goto(){"+
						...
						if(iframe){
							text.append("f = document.getElementById(\"output_frame\");"+
