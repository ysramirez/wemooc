...
public class ClpSerializer {
	...
	public static Object translateInputMailTemplate(BaseModel<?> oldModel) {
		MailTemplateClp oldClpModel = (MailTemplateClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getMailTemplateRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.tls.liferaylms.mail.model.impl.MailTemplateImpl")) {
			return translateOutputMailTemplate(oldModel);
		}
	...
	public static Object translateOutputAuditSendMails(BaseModel<?> oldModel) {
		AuditSendMailsClp newModel = new AuditSendMailsClp();
	...
	public static Object translateOutputMailTemplate(BaseModel<?> oldModel) {
		MailTemplateClp newModel = new MailTemplateClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setMailTemplateRemoteModel(oldModel);
