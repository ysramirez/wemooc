...
/**
 * The base implementation of the mail job local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.tls.liferaylms.mail.service.impl.MailJobLocalServiceImpl}.
 * </p>
 *
 * @author je03042
 ...
 * @generated
 */
public abstract class MailJobLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MailJobLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.tls.liferaylms.mail.service.MailJobLocalServiceUtil} to access the mail job local service.
	 */
	...
	public MailJob addMailJob(MailJob mailJob) throws SystemException {
		mailJob.setNew(true);

		return mailJobPersistence.update(mailJob, false);
	}
	 ...
	 */
	public MailJob createMailJob(long idJob) {
		return mailJobPersistence.create(idJob);
	}
	...
	public MailJob deleteMailJob(long idJob)
		throws PortalException, SystemException {
		return mailJobPersistence.remove(idJob);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MailJob deleteMailJob(MailJob mailJob) throws SystemException {
		return mailJobPersistence.remove(mailJob);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(MailJob.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return mailJobPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return mailJobPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return mailJobPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return mailJobPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public MailJob fetchMailJob(long idJob) throws SystemException {
		return mailJobPersistence.fetchByPrimaryKey(idJob);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MailJob getMailJob(long idJob)
		throws PortalException, SystemException {
		return mailJobPersistence.findByPrimaryKey(idJob);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return mailJobPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MailJob getMailJobByUuidAndGroupId(String uuid, long groupId)
		throws PortalException, SystemException {
		return mailJobPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MailJob> getMailJobs(int start, int end)
		throws SystemException {
		return mailJobPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getMailJobsCount() throws SystemException {
		return mailJobPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MailJob updateMailJob(MailJob mailJob) throws SystemException {
		return updateMailJob(mailJob, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MailJob updateMailJob(MailJob mailJob, boolean merge)
		throws SystemException {
		mailJob.setNew(false);

		return mailJobPersistence.update(mailJob, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.tls.liferaylms.mail.model.MailJob",
			mailJobLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = mailJobPersistence.getDataSource();
	...
	private MailJobLocalServiceClpInvoker _clpInvoker = new MailJobLocalServiceClpInvoker();
}