...
import com.liferay.lms.model.ActManAuditModel;
import com.liferay.lms.model.ActManAuditSoap;
...
/**
 * The base model implementation for the ActManAudit service. Represents a row in the &quot;lms_ActManAudit&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.lms.model.ActManAuditModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ActManAuditImpl}.
 * </p>
 *
 * @author TLS
 * @see ActManAuditImpl
 * @see com.liferay.lms.model.ActManAudit
 * @see com.liferay.lms.model.ActManAuditModel
 * @generated
 */
@JSON(strict = true)
public class ActManAuditModelImpl extends BaseModelImpl<ActManAudit>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a act man audit model instance should use the {@link com.liferay.lms.model.ActManAudit} interface instead.
	 */
	public static final String TABLE_NAME = "lms_ActManAudit";
	...
	public static final String TABLE_SQL_CREATE = "create table lms_ActManAudit (uuid_ VARCHAR(75) null,actManAuditId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,courseId LONG,className VARCHAR(75) null,start_ DATE null,end_ DATE null,state_ VARCHAR(75) null,userTargetId LONG,actId LONG)";
	public static final String TABLE_SQL_DROP = "drop table lms_ActManAudit";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.lms.model.ActManAudit"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.lms.model.ActManAudit"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.lms.model.ActManAudit"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferay.lms.model.ActManAudit"));
